...
'''
        Original Author(s): cefn
        
        Description:
                    > Modified version of circuitpythons 'busio.py' that works with MicroPython
                    > Original CircuitPython busio:
                    https://github.com/adafruit/Adafruit_Blinka/blob/main/src/busio.py
        
        Assumptions:
                    > Board is the Pi Pico
                    > Chip is the RP2040
'''
...
class I2C(Lockable):
    ...
    # This init method seems to work (untested)
    def init(self, scl, sda, frequency):
        """Initialization"""
        self.deinit()
        if CHIP_ID == CHIP_ID:
            from i2c import I2C as _I2C
